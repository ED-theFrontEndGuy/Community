...
dotnet ef migrations add --project App.DAL.EF --startup-project WebApp --context AppDbContext ModifyIdentity
dotnet ef database update --project App.DAL.EF --startup-project WebApp --context AppDbContext ModifyIdentity
