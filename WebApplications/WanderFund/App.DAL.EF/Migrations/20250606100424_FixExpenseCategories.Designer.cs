...
namespace App.DAL.EF.Migrations
{
    ...
    [Migration("20250606100424_FixExpenseCategories")]
    partial class FixExpenseCategories
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("App.Domain.ExpenseCategory", b =>
                {
                    b.HasOne("App.Domain.Expense", "Expense")
                        .WithOne("ExpenseCategory")
                        .HasForeignKey("App.Domain.ExpenseCategory", "ExpenseId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
