...
namespace WebApp.Controllers
{
    public class ContactTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ContactTypeName,Id")] ContactType contactType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("ContactTypeName,Id")] ContactType contactType)
        {
